...
// SSL shutdown modes
const (
	SSL_NO_SHUTDOWN       = C.GO_SSL_NO_SHUTDOWN
	SSL_SENT_SHUTDOWN     = C.GO_SSL_SENT_SHUTDOWN
	SSL_RECEIVED_SHUTDOWN = C.GO_SSL_RECEIVED_SHUTDOWN
)

// BIO lookup types
const (
	BIO_LOOKUP_CLIENT = C.GO_BIO_LOOKUP_CLIENT
	BIO_LOOKUP_SERVER = C.GO_BIO_LOOKUP_SERVER
)
