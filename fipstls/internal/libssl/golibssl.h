...
int go_openssl_ctx_configure(GO_SSL_CTX_PTR ctx, long minTLS, long maxTLS, long options, int verifyMode, const char *nextProto, const char *caPath, const char *caFile);
